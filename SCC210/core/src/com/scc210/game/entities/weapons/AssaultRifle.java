...
//need to fix the formula in Gun to account for correct pos of weapon
    public AssaultRifle(Texture texture, float posX, float posY, List<UpdatableEntity> entities, RayHandler handler){

        super(posX, posY, entities, 33, handler);
